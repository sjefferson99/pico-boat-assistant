# Incomplete project
None of the below fully works as a unified solution as yet, this is very alpha
...
The relay API endpoint presents and responds to API calls as documented at "/relay", the code assumes local operation and needs logic building to abstract hardware from webserver over I2C
...
Lights API framework with a driver in place of hardware include to abstract I2c and local as needed is started, only just worked out how to get the hardware class made available to the API endpoint class.
