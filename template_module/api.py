...
class templateapi:
    ...
    def __init__(self, coresite: website) -> None:
        ...
        """
        # Template API page
        @coresite.app.route('/template/api')
        async def api(request, response):
            ...
            <html>
                <body>
                    ...
                    <ul>
                    <li>List templates and names - GET /template/api/templates/</li>
                    <li>Switch or toggle template - PUT /template/api/templates/{template number (1-4)}</li>
                    </ul>
                    Data:
                    <ul>
        ...
        coresite.app.add_resource(templatelist, '/template/api/templates')
        coresite.app.add_resource(template, '/template/api/templates/<templateid>')
